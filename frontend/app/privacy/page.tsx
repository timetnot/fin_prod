          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-semibold text-black tracking-tight">Политика конфиденциальности</h1>
              </div>
              <Link
                href="/dashboard"
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-12">
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">1. Введение</h2>
          ...
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">2. Сбор информации</h2>
            <p className="text-black/60 leading-relaxed mb-4">
          ...
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">3. Использование информации</h2>
            <p className="text-black/60 leading-relaxed mb-4">
          ...
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">4. Защита информации</h2>
            <p className="text-black/60 leading-relaxed mb-4">
          ...
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">5. Ваши права</h2>
            <p className="text-black/60 leading-relaxed mb-4">
          ...
          <section className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 shadow-2xl shadow-black/10">
            <h2 className="text-3xl font-bold text-black mb-6 tracking-tight">6. Контакты</h2>
