      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-20">
          <h1 className="text-6xl lg:text-7xl font-black text-black leading-tight tracking-tight mb-6">
            Присоединяйтесь<br />
            <span className="text-black/70">к SubGrid</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 text-center shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-shadow duration-300">
            ...
            <p className="text-black/60 font-medium uppercase tracking-widest">Членов команды</p>
          </div>
          <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 text-center shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-shadow duration-300">
            <div className="text-5xl font-black text-black mb-2">15+</div>
            <p className="text-black/60 font-medium uppercase tracking-widest">Стран</p>
          </div>
          <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 text-center shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-shadow duration-300">
            <div className="text-5xl font-black text-black mb-2">100%</div>
            <p className="text-black/60 font-medium uppercase tracking-widest">Годовой рост</p>
          </div>
        </div>

        {/* Open Positions */}
        <div className="mb-20">
          <h2 className="text-4xl font-black text-black mb-12 tracking-tight">Открытые вакансии</h2>
          <div className="space-y-6">
            {openPositions.map((position, index) => (
              <div key={index} className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-8 shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-all duration-300 hover:-translate-y-1">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                  <div className="mb-6 lg:mb-0">
                    <h3 className="text-2xl font-bold text-black mb-3">{position.title}</h3>
                    <p className="text-black/60 mb-4 leading-relaxed">{position.description}</p>
                    <div className="flex flex-wrap gap-3">
                      <span className="inline-block px-4 py-2 bg-black/5 text-black font-bold text-xs uppercase tracking-wider rounded-lg">
                        {position.department}
                      </span>
                      <span className="inline-block px-4 py-2 bg-black/5 text-black font-bold text-xs uppercase tracking-wider rounded-lg">
                        {position.location}
                  ...
                  <button className="bg-gradient-to-br from-black via-black/95 to-black/90 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-black/95 hover:via-black/90 hover:to-black/85 transition-all shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-black/30 transform hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group">
        ...
        {/* Benefits Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-black text-black mb-12 tracking-tight">Преимущества</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-8 shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-shadow duration-300">
        ...
        {/* Culture Section */}
        <div className="bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-2xl rounded-3xl border border-black/5 p-10 mb-20 shadow-2xl shadow-black/10 hover:shadow-3xl hover:shadow-black/15 transition-shadow duration-300">
          <h2 className="text-4xl font-black text-black mb-8 tracking-tight">Наша культура</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold text-black mb-6">Фундаментальные ценности</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-4">
                  ...
                  <span className="text-black/70 font-medium">Постоянные инновации</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Полная прозрачность</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Фокус на пользователе</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Командная работа</span>
                </li>
              </ul>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-black mb-6">Наша среда</h3>
              <ul className="space-y-4">
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Коллаборативная среда</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Возможности для роста</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Разнообразная и инклюзивная команда</span>
                </li>
                <li className="flex items-start space-x-4">
                  <div className="w-8 h-8 bg-black rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-black/70 font-medium">Баланс работы и жизни</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* CTA Section */}
        <div className="text-center bg-gradient-to-br from-black via-black/95 to-black/90 rounded-3xl p-12 shadow-2xl shadow-black/30">
