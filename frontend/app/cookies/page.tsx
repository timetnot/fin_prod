      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-12">
          <section className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <h2 className="text-3xl font-bold text-white mb-6 tracking-tight">Что такое cookies?</h2>
          ...
          <section className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <h2 className="text-3xl font-bold text-white mb-6 tracking-tight">Типы cookies</h2>
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-purple-700/70 via-pink-700/70 to-rose-700/70 rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Необходимые cookies</h3>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Аналитические cookies</h3>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Маркетинговые cookies</h3>
                  <p className="text-gray-400 leading-relaxed">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white mb-2">Функциональные cookies</h3>
                  <p className="text-gray-400 leading-relaxed">
          ...
          <section className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <h2 className="text-3xl font-bold text-white mb-8 tracking-tight">Настройки cookies</h2>
            <div className="space-y-6">
              <div className="flex items-center justify-between p-6 bg-white/5 rounded-2xl">
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Необходимые cookies</h3>
                  <p className="text-gray-500 text-sm">Обязательны для работы сайта</p>
                </div>
                <div className="w-14 h-8 bg-gradient-to-r from-purple-700/70 via-pink-700/70 to-rose-700/70 rounded-full p-1 cursor-not-allowed opacity-50">
                  <div className="w-6 h-6 bg-white rounded-full shadow-md"></div>
                </div>
              </div>
              <div className="flex items-center justify-between p-6 bg-white/5 rounded-2xl hover:bg-white/10 transition-colors">
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Аналитические cookies</h3>
                  <p className="text-gray-500 text-sm">Помогают улучшить наш сервис</p>
                </div>
                <button
                  onClick={() => setPreferences({ ...preferences, analytics: !preferences.analytics })}
                  className={`w-14 h-8 rounded-full p-1 transition-colors ${preferences.analytics ? 'bg-gradient-to-r from-purple-700/70 via-pink-700/70 to-rose-700/70' : 'bg-white/20'}`}
                >
              ...
              <div className="flex items-center justify-between p-6 bg-white/5 rounded-2xl hover:bg-white/10 transition-colors">
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Маркетинговые cookies</h3>
                  <p className="text-gray-500 text-sm">Персонализированная реклама</p>
                </div>
                <button
                  onClick={() => setPreferences({ ...preferences, marketing: !preferences.marketing })}
                  className={`w-14 h-8 rounded-full p-1 transition-colors ${preferences.marketing ? 'bg-gradient-to-r from-purple-700/70 via-pink-700/70 to-rose-700/70' : 'bg-white/20'}`}
                >
              ...
              <div className="flex items-center justify-between p-6 bg-white/5 rounded-2xl hover:bg-white/10 transition-colors">
                <div>
                  <h3 className="text-lg font-bold text-white mb-1">Функциональные cookies</h3>
                  <p className="text-gray-500 text-sm">Сохранение настроек</p>
                </div>
                <button
                  onClick={() => setPreferences({ ...preferences, functional: !preferences.functional })}
                  className={`w-14 h-8 rounded-full p-1 transition-colors ${preferences.functional ? 'bg-gradient-to-r from-purple-700/70 via-pink-700/70 to-rose-700/70' : 'bg-white/20'}`}
                >
          ...
          <section className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <h2 className="text-3xl font-bold text-white mb-6 tracking-tight">Как управлять cookies</h2>
            <p className="text-gray-400 leading-relaxed mb-4">
            ...
            <p className="text-gray-400 leading-relaxed">
              Для получения дополнительной информации о cookies и их управлении посетите <Link href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-purple-300 font-bold hover:underline">www.allaboutcookies.org</Link>
            </p>
          </section>
          ...
          <section className="text-center">
            <Link 
              href="/"
              className="inline-block bg-white/5 border border-white/10 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
