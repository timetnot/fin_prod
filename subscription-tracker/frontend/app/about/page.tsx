      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-700/70 via-pink-700/70 to-rose-700/70 rounded-2xl flex items-center justify-center mb-6 shadow-2xl shadow-purple-700/20">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
            </div>
            <h2 className="text-3xl font-bold text-white mb-4 tracking-tight">Наша миссия</h2>
          ...
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            ...
            <h2 className="text-3xl font-bold text-white mb-4 tracking-tight">Наше видение</h2>
            <p className="text-gray-400 mb-4 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 text-center shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            ...
            <p className="text-gray-400 font-medium uppercase tracking-widest">Активных пользователей</p>
          </div>
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 text-center shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <div className="text-5xl font-black text-white mb-2">$2.5M+</div>
            <p className="text-gray-400 font-medium uppercase tracking-widest">Общая экономия</p>
          </div>
          <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-10 text-center shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
            <div className="text-5xl font-black text-white mb-2">99.9%</div>
            <p className="text-gray-400 font-medium uppercase tracking-widest">Uptime</p>
          </div>
        </div>

        {/* Team Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-black text-white mb-12 text-center tracking-tight">Наша команда</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8 text-center shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-all duration-300 hover:-translate-y-1">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-700/70 via-pink-700/70 to-rose-700/70 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-purple-700/20">
                  <span className="text-2xl font-black text-white">{member.image}</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">{member.name}</h3>
                <p className="text-gray-400 font-bold mb-2 uppercase tracking-widest">{member.role}</p>
        ...
        {/* Values Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-black text-white mb-12 text-center tracking-tight">Наши ценности</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-8 shadow-2xl shadow-black/50 hover:shadow-3xl hover:shadow-purple-700/15 transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Прозрачность</h3>
              <p className="text-gray-400 leading-relaxed">
        ...
        {/* CTA Section */}
        <div className="text-center bg-white/5 backdrop-blur-2xl rounded-3xl border border-white/10 p-12 shadow-2xl shadow-black/50">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            ...
            <Link 
              href="/contact" 
              className="bg-white/5 border-2 border-white/10 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-white/10 hover:border-white/20 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Связаться с нами
            </Link>
          </div>
