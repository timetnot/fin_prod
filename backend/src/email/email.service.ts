...
export class EmailService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    // Иначе используем бесплатный Ethereal для тестирования
    console.log('Using Ethereal test SMTP (emails not delivered to real addresses, only preview)');
    ...
    console.log('  Note: Use preview URL to see sent emails');
  }
